            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <!-- get_field_value - эта функция будет сохранять введенные данные при ошибке валидации чтобы не вводить их снова  -->
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
...
<script>
    function popupBaseImage() { // функция для загрузки отдельной картинки
        CKFinder.popup( {
            chooseFiles: true,
...
<script>
    function popupGalleryImage() { // функция для загрузки множество картинок
        CKFinder.popup( {
            chooseFiles: true,
            onInit: function( finder ) {
                finder.on( 'files:choose', function( evt ) {
