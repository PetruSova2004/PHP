...
class DownloadController extends AppController
{
    ...
    public function indexAction()
    {
        ...
        $downloads = $this->model->get_downloads($lang, $start, $perpage); // получаем список файлов на базовом языке
    ...
    public function addAction()
    {
        if (!empty($_POST)) {
            if ($this->model->download_validate()) {
                if ($data = $this->model->upload_file()) { // загружаем файл в указанную папку
