$(function () { // при удалении выскакивало подтверждение как alert
    ...
    $(".is-download").select2({
        ...
        minimumInputLength: 1, // с какого символа отправлять ajax запрос
        cache: true,
        ajax: {
            url: ADMIN + "/product/get-download", // куда отправляем запрос
            delay: 250, // задержка
            dataType: 'json',
